...
with app.app_context():
    ...
    # 添加资源数据
    resources_data = [
        {'name': '用户管理', 'url': '/users', 'pid': None},
        {'name': '角色管理', 'url': '/roles', 'pid': None},
        {'name': '资源管理', 'url': '/resources', 'pid': None},
        {'name': '接口管理', 'url': '/interfaces', 'pid': None},
    ...
    # 添加接口数据
    interfaces_data = [
        {'url': '/users/login', 'resource': 1},
        {'url': '/users/register', 'resource': 1},
        {'url': '/users/add_user', 'resource': 1},
        {'url': '/users/add_role', 'resource': 2},
        {'url': '/users/add_resource', 'resource': 3}
    ]
